...
- 描述情况
1. 本地升级taro,导致项目无法启动
> 本地全局安装taro,无法升级版本(taro update self) 
> 升级项目taro版本也是一直在报错(taro update project 3.2.1)
> 使用本地全局3.2.1版本创建新的taro项目,把旧的文件全部拷进来
> 解决
2. 国内转换api无法连接
> 

#### 8/26
- 找到一个新的github第三方项目 Getter
[开发文档](https://juejin.cn/post/6844903768388009998)
> 从他的开发文档中知道
> 官方并没有提供, trending的接口
> 他使用的是云开发 + 爬虫数据的方式获取数据展示在小程序端
